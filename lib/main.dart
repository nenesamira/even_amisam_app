...
import 'package:even_amisam_app/pages/add_question_page.dart';
import 'package:even_amisam_app/pages/chat_page.dart';
import 'package:even_amisam_app/pages/conference_live_page.dart'; // Import ConferenceLivePage
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      initialRoute: '/', // Route initiale pour la page de diffusion en direct
      routes: {
        ...
        '/live': (context) => const LivePage(isHost: true), // Route pour LivePage
        '/conferenceLive': (context) => const ConferenceLivePage(isHost: true), // Route pour ConferenceLivePage
        '/addQuestion': (context) => AddQuestionPage(), // Route pour AddQuestionPage
        '/chat': (context) => ChatPage(), // Route pour ChatPage
      },
    );
  }
}
