import 'package:even_amisam_app/pages/shared_poll_pag.dart';
import 'package:flutter/material.dart';
import 'shared_poll_page.dart'; // Assurez-vous que ce chemin est correct

class PollResultPage extends StatelessWidget {
  final int numberOfVoters = 100; // Exemple de nombre de participants ayant voté
          ...
          children: [
            ...
            Row(
              children: [
                ElevatedButton(
                  onPressed: () {
                    // Logique pour relancer le sondage
                  },
                  child: Text('Relancer le sondage'),
                ),
                Spacer(),
                ElevatedButton(
                  onPressed: () {
                    // Navigation vers la nouvelle page SharedPollPage
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => SharedPollPage(numberOfVoters: numberOfVoters),
                      ),
                    );
                  },
                  child: Text('Partager le sondage'),
                ),
              ],
            ),
          ],
